    ...
    <div
      ...
      <div
        ...
        <h2
          ...
          <span className="block text-sm font-normal opacity-70">生成失败</span>
          Generation Failed
        </h2>
        {message.map((m) => (
        ...
        <div className="mt-8 flex justify-center gap-4">
          <button
            onClick={onSelectKey}
            className="px-8 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800 text-center">
            <span className="block text-xs font-normal opacity-90 mb-0.5">添加 API 密钥</span>
            Add API Key
          </button>
          <button
            onClick={onClose}
            className="px-8 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-semibold transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-800 text-center">
            <span className="block text-xs font-normal opacity-90 mb-0.5">关闭</span>
            Close
          </button>
        </div>
      </div>
