      ...
      <div className="w-full max-w-2xl bg-gray-800 p-6 md:p-8 rounded-lg shadow-2xl">
        <header className="mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-1">
            <span className="block text-sm font-normal opacity-70">编辑视频</span>
            Edit Video
          </h1>
        </header>
        ...
        <main>
          <div className="mb-6">
            <label
              ...
              <span className="block text-xs opacity-70 mb-0.5">视频文本提示词</span>
              Video text prompt
            </label>
            <textarea
              id="description"
        ...
        <footer className="flex justify-end gap-4">
          <button
            onClick={onCancel}
            className="px-6 py-2 rounded-lg bg-gray-600 hover:bg-gray-700 text-white font-semibold transition-colors text-center">
            <span className="block text-xs font-normal opacity-80 mb-0.5">取消</span>
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="px-6 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-semibold transition-colors text-center">
            <span className="block text-xs font-normal opacity-90 mb-0.5">生成新视频</span>
            Generate new video
          </button>
        </footer>
      </div>
